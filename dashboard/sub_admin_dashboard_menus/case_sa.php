...
<body>
		...
		<div class="content">
			...
			<form class="form-inline">
    			<input class="form-control mr-sm-2" type="search" placeholder="Enter File ID" aria-label="Search">
...
?>	
			...
			<div class="card bg-light my-5 mx-auto" style="max-width: 50rem;">
				...
				<h5>FILE id: <?php echo $fid;  ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					SUBJECT: <?php echo $subject;  ?></h5>
					
					<p class="float-left align-middle">
						<a href="view_fir.php?edit=<?php echo $fid ?>"><button type="button" class="btn btn-primary">View FILE</button></a>
					</p>
				</div>
		...
		<footer id="site-footer">
			...
			<div class="footer-copyright">
            	<p>&copy;2023 All Rights Reserved | Designed By <a href="https://www.linkedin.com/in/penudagreat/"><span>Penuel Kibet</span></a> </p>
        	</div>
