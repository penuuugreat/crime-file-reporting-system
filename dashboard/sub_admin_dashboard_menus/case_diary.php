				...
				<section class="row justify-content-center">
					<section class="col-12 col-sm-6 col-md-6">
						...
						<div class="form-row">
							...
							<h3 class="text-left my-4">Case Summary</h3>
							<div class="form-group">
			    			...
			    			<div class="form-group">
			    				...
			    				<label for="c_details">Details According To FILE</label>
			    		...
			    		<h3 class="text-left my-4">Output Statement On the Case</h3>
			    		<div class="form-group">
			    				<label for="io_statement"> Statement</label>
