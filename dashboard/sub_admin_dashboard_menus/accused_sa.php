...
<body>
		...
		<div class="content">
			...
			<form class="form-inline float-right my-4 mx-4" action="accused_sa.php" method="post">
    			<input class="form-control mr-sm-2" type="search" placeholder="Enter FILE ID" aria-label="Search"  name="valueToSearch">
