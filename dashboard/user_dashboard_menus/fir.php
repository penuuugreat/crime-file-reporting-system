		...
		<nav class="navbar navbar-expand-lg navbar-light sticky-top navbar-custom">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav mr-auto w-100 justify-content-end px-4">
					...
					<li class="nav-item"><a href="fir.php" class="nav-link">FILE</a></li>
				...
				<section class="row justify-content-center">
					<section class="col-12 col-sm-6 col-md-6">
						<form class="form-container" action="./../../php/fir_back.php" method="POST" enctype="multipart/form-data">
							<h2 class="text-center font-weight-bold">FILE </h2>
							...
							<div class="form-row">
								...
								<div class="col">
									<div class="custom-control custom-radio custom-control-inline">
		  							...
		  							<label class="custom-control-label" for="voter_no">ID No</label>
									</div>
								</div>
								<div class="col">
									<div class="custom-control custom-radio custom-control-inline">
								...
								<div class="col">
									<div class="custom-control custom-radio custom-control-inline">
		  							...
		  							<label class="custom-control-label" for="adhar_no">Passport No</label>
									</div>
								</div>
							</div>
						...
						<div class="form-row">
			    			<div class="col">
			    				<label for="fid">FILE Id</label>
			      				<input type="text" class="form-control" placeholder="Enter FILE id" name="fid" id="fid" value="<?php echo(mt_rand(999,9999));?>">
			    			</div>
			    			<div class="col">
			    				<label for="vid">Victim Id</label>
			      				<input type="text" class="form-control" placeholder="Enter Victim id" name="vid" id="vid" value="<?php echo(mt_rand(999,9999));?>">
			    			</div>
  						</div>
  							<div class="form-group">
  								<label for="subject">type of complaint</label>
        						<select id="subject" class="form-control" name="subject" placeholder="Enter Subject" required="required" id="subject" required="required">
						...
						<div class="form-row">
			    			...
			    			<div class="col">
  							...
  							<div class="form-row">
  								<label for="a_name">Accused Name (optional*)</label>
        						<input type="text" class="form-control" name="a_name" placeholder="Enter Accused Name" id="a_name">
        					</div>
  							<div class="form-row">
  								<label for="a_name">Accused address (optional*)</label>
								<textarea class="form-control" rows="3" id="a_name="address"></textarea>
        					</div> 
        				<div class="form-row">
			    			<div class="col">
			    				<label for="f_date">FILE Submit Date</label>
			      				<input type="date" class="form-control" placeholder="Enter FIR Submission Date" name="f_date" id="f_date" required="required">
			    			</div>
			    			<div class="col">
			    				<label for="f_time">FILE Submit Time</label>
        					...
        					<div class="form-check checked">
								<label class="form-check-label my-3">
							    	<input type="checkbox" class="form-check-input" value="true" required="required">I, hereby verify that the above details i gave in the FILE are to be true to my knowledge. 
								</label>
							</div>
							<div class="form-group">
		...
		<footer id="site-footer">
			<div class="container">
				<div class="row text-center custom-list">
					...
					<div class="col-sm-4">
						<ul class="list-unstyled">
							<li><a href="fir.php" class="nav-link">File a FILE</a></li>
			...
			<div class="footer-copyright">
            	<p>&copy;2023 All Rights Reserved | Designed By <a href="https://www.linkedin.com/in/manashjb/"><span>Penuel Kibet</span></a> </p>
        	</div>
