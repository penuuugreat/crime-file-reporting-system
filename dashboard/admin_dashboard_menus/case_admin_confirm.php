					...
					<div class="form-row">
		    			<div class="col">
		    				<label for="fid">FILE Id</label>
		      				<input type="text" class="form-control" placeholder="FILE id" name="fid" value="<?php echo $row['fid']; ?>" >
		    			</div>
		    			<div class="col">
					...
					<div class="form-row">
		    			<div class="col">
		    				<label for="f_date">FILE Submit Date</label>
		      				<input type="date" class="form-control" placeholder="FILE Submit Date" name="f_date" value="<?php echo $row['f_date']; ?>" >
		    			</div>
		    			<div class="col">
		    				<label for="f_time">FILE Submit Time</label>
		      				<input type="time" class="form-control" placeholder="FILE Submit Time" name="f_time" value="<?php echo $row['f_time']; ?>" >
		    			</div>
...
?>
		...
		<footer id="site-footer">
			...
			<div class="social-networks">
				...
				<a href="mailto:nupecherz254@gmail.com?subject=Mail from Our Site" class="google"><i class="fab fa-google-plus-g"></i></a>
			</div>
