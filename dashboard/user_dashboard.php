...
<body>	
		<nav class="navbar navbar-expand-lg navbar-light sticky-top navbar-custom">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav mr-auto w-100 justify-content-end px-4">
					...
					<li class="nav-item"><a href="user_dashboard_menus/fir.php" class="nav-link">FIlE</a></li>
		...
		<div class="content">
			...
			<div class="jumbotron text-center">
			  ...
			  <img src="../img/police 2.jpg" style="width: 400px; height: 400px;">
		...
		<footer id="site-footer">
			<div class="container">
				<div class="row text-center custom-list">
					...
					<div class="col-sm-4">
						<ul class="list-unstyled">
							<li><a href="user_dashboard_menus/fir.php" class="nav-link">File a FIlE</a></li>
